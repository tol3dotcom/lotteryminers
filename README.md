...
>A popular open-source wallet

[BlueWallet Instructions](bluewallet.md)
>A popular open-source mobile wallet (iOS and Android)


## 2. NerdMiner V2 Setup: Your Bitcoin Lottery Ticket
>NerdMiner V2, NanoMiner, and NanoMiner Tower devices
